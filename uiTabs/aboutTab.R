...
aboutTab <- tabPanel(
  ...
  h3("Citation"),
  p(
    "If you use or modify FASTAptameR 2.0, please cite: Kramer, S. T., Gruenke, P. R., Alam, K. K., Xu, D. & Burke, D. H. FASTAptameR 2.0: A web tool for combinatorial sequence selections. Molecular Therapy - Nucleic Acids vol. 29 862–870 (2022)."
  ),
  ...
  # update section
  h3("The most recent version of FA2 is from 05 June 2023."),
